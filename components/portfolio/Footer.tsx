  ...
  return (
    <footer id="contact" className="bg-slate-900 text-white py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-3xl font-bold mb-6">Contact for Recruitment</h2>
        <p className="text-slate-300 mb-10 text-lg max-w-2xl mx-auto">
          포트폴리오를 끝까지 읽어주셔서 감사합니다.
          <br />
          귀사의 백엔드 개발 및 서비스 고도화에 기여할 수 있는 기회를 기다리고
          있습니다.
          <br />
          채용 관련 추가 문의나 인터뷰 제안은 아래 이메일로 연락해 주시면
          감사하겠습니다.
        </p>
        ...
        <div className="border-t border-white/10 pt-8 text-sm text-slate-500">
          <p>© 2025 이세창 (Sechang Lee). All rights reserved.</p>
          <p className="mt-2">
