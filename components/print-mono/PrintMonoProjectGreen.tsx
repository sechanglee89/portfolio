...
export function PrintMonoProjectGreen() {
  return (
    <>
      {/* 프로젝트 개요 */}
      <div className="page">
        ...
        <div className="print-section">
          ...
          <div className="mt-3">
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-[8pt]">
              ...
              <div className="flex items-center gap-1">
                <span className="print-mono-badge">Monitoring</span>
        ...
        {/* 시스템 아키텍처 */}
        <div className="print-section">
          <h3 className="print-subsection-title">시스템 아키텍처 설계</h3>
        ...
        <div className="print-grid-3 text-[8pt]">
          <div className="print-card">
            ...
            <ul className="space-y-0.5">
              ...
              <li>
                • 반복 초과/필수 헤더 누락 패턴이 임계치를 넘으면 IP 자동 차단
              </li>
            </ul>
          </div>
          <div className="print-card">
            ...
            <ul className="space-y-0.5">
              <li>• 이상 패턴 감지 시 Turnstile 챌린지 요구</li>
              <li>• 성공 시 단일 사용·짧은 만료시간의 내부 챌린지 토큰 발급</li>
              <li>• Siteverify API로 응답 토큰 검증</li>
            </ul>
          </div>
          <div className="print-card">
            ...
            <ul className="space-y-0.5">
              <li>• 비밀번호 일치 시에만 문의 단위 접근 토큰 발급</li>
              <li>• 유효기간 동안 비밀번호 재입력 없이 조회/수정/삭제 가능</li>
          ...
          <div className="print-card">
            ...
            <ul className="space-y-0.5">
              <li>• X-Action-Token, X-Request-Id, X-Payload-Hash 필수</li>
              <li>• Redis 저장값 비교로 변조/재전송 여부 검증</li>
              <li>• 중간자 공격 방어 레이어 확보</li>
            </ul>
          </div>
          <div className="print-card">
            ...
            <ul className="space-y-0.5">
              ...
              <li>• Refresh Token: HttpOnly·Secure Cookie 저장</li>
              <li>• TOTP 기반 2단계 인증</li>
          ...
          <div className="print-card">
            ...
            <ul className="space-y-0.5">
              <li>• 개인정보 AES-GCM 암호화 + 검색용 해시 분리 저장</li>
              <li>• 정적 텍스트 Redis 캐싱</li>
            </ul>
          </div>
        </div>
