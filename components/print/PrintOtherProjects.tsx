export function PrintOtherProjects() {
  const projects = [
    {
  ...
  return (
    <div className="page">
      <h2 className="print-section-title">📂 기타 프로젝트</h2>
      <p className="text-[9pt] text-slate-500 mb-4">
        ...
        {projects.map((project, index) => (
          <div key={index} className="print-card">
            <div className="flex justify-between items-start mb-1">
              ...
              <div className="text-[8pt] text-slate-500">{project.period}</div>
            </div>
            ...
            <div className="flex flex-wrap gap-1">
              {project.tech.map((t) => (
                <span key={t} className="print-badge">
                  {t}
                </span>
              ))}
            </div>
